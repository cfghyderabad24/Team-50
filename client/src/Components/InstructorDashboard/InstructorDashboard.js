...
//                     <li key={student._id} onClick={() => setSelectedStudent(student)}>{student.firstname} {student.lastname}</li>
//                 ))}
//             </ul>
...
//                         <label>
//                             Attendance:
//                             <input type="text" value={evaluation.attendance} onChange={(e) => setEvaluation({ ...evaluation, attendance: e.target.value })} required />
//                         </label>
//                         <label>
//                             Marks:
//                             <input type="number" value={evaluation.marks} onChange={(e) => setEvaluation({ ...evaluation, marks: e.target.value })} required />
//                         </label>
//                         <label>
//                             Grade:
//                             <input type="text" value={evaluation.grade} onChange={(e) => setEvaluation({ ...evaluation, grade: e.target.value })} required />
//                         </label>
//                         <label>
//                             Therapy Type:
//                             <input type="text" value={evaluation.therapyType} onChange={(e) => setEvaluation({ ...evaluation, therapyType: e.target.value })} required />
//                         </label>
//                         <label>
//                             Remarks:
//                             <textarea value={evaluation.remarks} onChange={(e) => setEvaluation({ ...evaluation, remarks: e.target.value })} required></textarea>
//                         </label>
